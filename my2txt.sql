...
union all
select ' Latest Releases (MySQL):   8.4.2, 8.0.39; 9.0.1'
union all
select ' Latest Releases (MariaDB): 11.4.2, 11.3.2, 11.2.4, 11.1.5, 11.0.6, 10.11.7, 10.10.7, 10.6.15, 10.5.22, 10.4.31'
union all
